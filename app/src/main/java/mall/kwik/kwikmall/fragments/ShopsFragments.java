...
public class ShopsFragments extends BaseFragment{
    ...
    private View view;
    static RecyclerView recyclerViewShops;
    static RecyclerViewAdapterShops recyclerViewAdapter;
  ...
  //  private BroadcastReceiver mMessageReceiver;
    ...
    public void ifFilterActive(){


    }

    private void shopsListApi() {
        ...
        locationProvider.getLastKnownLocation()
                .subscribe(new Consumer<Location>() {
                    ...
                    public void accept(Location location) throws Exception {
                        ...
                        stringStringHashMap.put("type","Shop");
...
/*
        restClient.RestaurantsList(stringStringHashMap).enqueue(new Callback<RestaurantsListSuccess>() {
            @Override
            public void onResponse(Call<RestaurantsListSuccess> call, Response<RestaurantsListSuccess> response) {

                if(response.body().getSuccess()){



                    shopsListPayloadArrayList = new ArrayList<>(response.body().getPayload());

                    SharedPreferences.Editor mEdit1 = sharedPreferencesshops.edit();


                    Gson gson = new Gson();
                    List<RestaurantsListPayload> textList = new ArrayList<RestaurantsListPayload>();
                    textList.addAll(shopsListPayloadArrayList);
                    String jsonText = gson.toJson(textList);
                    mEdit1.putString("keyshops", jsonText);
                    mEdit1.commit();
                    ...
                    recyclerViewAdapter.setOnItemClickListener(new RecyclerViewAdapterShops.ClickListener() {
                        ...
                        public void onItemClick(String string_form, String nameOfHotel, String address,int StoreId, View v) {
                            ...
                            UtilityCartData utilityRestaurants = new UtilityCartData(getContext());
                            ...
                            Bundle bundle = new Bundle();
                            utilityRestaurants.setRestId(StoreId);
            ...
            @Override
            public void onFailure(Call<RestaurantsListSuccess> call, Throwable t) {
